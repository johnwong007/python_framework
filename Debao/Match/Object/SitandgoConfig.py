...
class Rule:
    ...
    addon               = 'NO'  #是否addon
    addon_value         = 0     #addon买到的筹码值
    addon_paymoney      = 0     #addon支付金额
    addon_wait_time     = 0     #addon等待时间
    valid_rebuy_time    = 0     #合法的rebuy时间（距离开赛时间）
...
def load_rule(match_ids):
    ...
    for i in ret:
        ...
        r.match_unum        = i['min_player']       # 坐满即玩的参数人数就是最小参数人数
